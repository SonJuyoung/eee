...
<div class="container">
    ...
    <div class="join-body">
        <div class="join-info">
            ...
            <h5>아이디는 영문자로 시작하는 영문자 또는 숫자 6~20자 / 비밀번호는 8 ~ 30자 영문, 숫자, 특수문자를 최소 한가지씩 조합하세요.</h5>
        </div>
        <div class="join-input">
            ...
            <div>
                ...
                <div class="join-detail">
                    <label for="pw">(*)비밀번호 확인</label><input class="form-control" type="password" id="pwchk"
                                                             name="pwchk">
                </div>
                <div class="join-detail">
        ...
        <div class="address container">
            <div class="d-flex flex-column align-items-center">
                <div class="d-flex align-items-center justify-content-center w-50 mb-1">
                    <input type="text" class="form-control postcode" id="sample6_postcode" placeholder="우편번호">
                ...
                <div class="d-flex align-items-center w-50 mb-1">
                    <input type="text" class="form-control w-100 main-address" id="sample6_address" placeholder="주소" readonly><br>
                </div>
